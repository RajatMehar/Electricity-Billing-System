...
public class Signup extends JFrame implements ActionListener {
    ...
    Signup(){
        ...
        JLabel head1 = new JLabel("Register Your Account Here ");
        head1.setBounds(40,10,400,30);
        head1.setFont(new Font("TimesRoman", Font.BOLD , 25));
        add(head1);

        JLabel createAs = new JLabel("Create Account As");
        createAs.setBounds(30,63,125,20);
        add(createAs);

        loginASCho = new Choice();
        loginASCho.add("Admin");
        loginASCho.add("Customer");
        loginASCho.setBounds(170,63,120,20);
        add(loginASCho);
